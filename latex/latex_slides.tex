...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item Line comments start with \verb|%|
  \end{itemize}
...
\frame{
  \frametitle{Exercise 2: Sections}
  \begin{itemize}
...
\begin{frame}[fragile]
  \frametitle{Exercise 2: Sections (Solution)}
...
\end{document}\end{verbatim} }
\begin{itemize} \small
  \item Omitting \verb|date{...}| or using \verb|date{\today}| causes document to use today's date
\end{itemize}
\end{frame}
...
\begin{frame}[fragile]
  \frametitle{Exercise 3: Definition of Derivative}
  \begin{itemize}
...
\begin{frame}[fragile]
  \frametitle{Exercise 3: Definition of Derivative (Solution)}
  \begin{itemize}
    \item Produce the following equation in \LaTeX{}:
    \[ \frac{\mathrm{d}f(x)}{\mathrm{d}x} = \lim_{\delta \to 0} \frac{f(x + \delta) - f(x)}{\delta} \]
    \item Solution:
...
\begin{frame}
  \frametitle{Exercise 4: More Math}
  \begin{itemize}
...
\begin{frame}[fragile]
  \frametitle{Exercise 4: More Math (Solution)}
  \begin{itemize}
    \item Produce the following equations in \LaTeX{}:
      \begin{align*}
        \begin{vmatrix}a & b \\ c & d\end{vmatrix} & = ad - bc \\
