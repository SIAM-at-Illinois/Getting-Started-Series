...
\begin{frame}[fragile]
  ...
  \end{itemize}
  \item Use \verb|latex| or \verb|pdflatex| command on a .tex file to produce output
  \begin{itemize}
    \item \verb|pdflatex| is recommended, since it can include .pdf, .jpg, .png image formats
      and outputs directly to .pdf
    \item \verb|latex| uses PostScript format
  \end{itemize}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Using the tool Latexmk can resolve this issue
    \end{itemize}
  \end{itemize}
\end{frame}
